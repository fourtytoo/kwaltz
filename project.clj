(defproject kwaltz "0.1.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.8.0"]
                 ...
                 [autoclave "0.1.7" :exclusions [com.google.guava/guava
  ...
  :uberjar-name "kwaltz.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main kwaltz.application
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                :figwheel {:on-jsload "kwaltz.system/reset"}

                :compiler {:main cljs.user
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/kwaltz.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "resources/public/js/compiled/testable.js"
                           :main kwaltz.test-runner
                           :optimizations :none}}

               {:id "min"
                :source-paths ["src/cljs" "src/cljc"]
                :jar true
                :compiler {:main kwaltz.system
                           :output-to "resources/public/js/compiled/kwaltz.js"
                           :output-dir "target"
                           :source-map-timestamp true
  ...
  :profiles {:dev
             ...
             {:source-paths ^:replace ["src/clj" "src/cljc"]
              :prep-tasks ["compile"
                           ["cljsbuild" "once" "min"]
                           ["run" "-m" "garden-watcher.main" "kwaltz.styles"]]
              :hooks []
              :omit-source true
              :aot :all}})
